# Nas funções de altera e apaga, peça ao usuário que confirme a alteração e
# exclusão do nome antes de realizar a operação
...
# --Função de confirmação do admin
def confirmar():
    print("\nTem certeza que deseja prosseguir?")
    print("[ 1 ] Sim")
    print("[ 0 ] Não")
    return int(input("Digite a opção: ").strip())
